...
const LANGS = {
  ...
  ru: {
    ...
    description: 'Red Crown Interactive разрабатывает приложения и интерактивное ПО для науки, инженерии и бизнеса: мобильные устройства, ПК и VR на Meta Quest, на Unity, от идеи до внедрения.',
    ogTitle: 'Red Crown Interactive · Разработка приложений и интерактивного ПО',
    ogDescription: 'Red Crown Interactive разрабатывает приложения и интерактивное ПО для науки, инженерии и бизнеса: мобильные устройства, ПК и VR на Meta Quest, на Unity, от идеи до внедрения.',
    twitterTitle: 'Разработка приложений и интерактивного ПО',
    twitterDescription: 'Red Crown Interactive разрабатывает приложения и интерактивное ПО для науки, инженерии и бизнеса, на Unity.',
    orgDescription: 'Студия разработки на Unity, создающая приложения и интерактивное ПО для науки, инженерии и бизнеса на мобильных устройствах, ПК и Meta Quest.',
    ...
    text: {
      ...
      'Robi, the in-house VR instructor that guides students through the experiment · drag to rotate': 'Роби, наш VR-инструктор, который ведёт студентов через эксперимент',
      'An actual 3D model generated by our LiveMol app · drag to rotate · use the slider to zoom': 'Настоящая 3D-модель из нашего приложения LiveMol. Ползунок приближает',
      'The headset our classroom runs on · drag to rotate · use the slider to zoom': 'Гарнитура, на которой работает наш класс. Ползунок приближает',
    },
  },
};
...
function localizeAttrs(html, map) {
  if (!map) return html;
  return html.replace(/\b(alt|aria-label|data-badge)="([^"]*)"/g,
...
function check(lang) {
  ...
  for (const m of out.matchAll(/\b(?:alt|aria-label|data-badge)="([^"]+)"/g)) {
    const v = m[1];
