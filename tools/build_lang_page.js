...
const LANGS = {
  ...
  he: {
    ...
    // swap below, printed the four model hints in English under the 3D models.
    text: {
      'Red Crown Interactive logo': 'הלוגו של Red Crown Interactive',
      'Virtual Reality projects': 'פרויקטים במציאות מדומה',
      'Mixed Reality projects': 'פרויקטים במציאות משולבת',
      'PC application projects': 'פרויקטים של אפליקציות למחשב',
      'Hardware setup projects': 'פרויקטים של הקמת חומרה',
      'Lioness leading three lion cubs wearing VR headsets': 'לביאה מובילה שלושה גורי אריות עם משקפי VR',
      'Julia Pavlov, Founder and Lead Engineer': 'יוליה פבלוב, מייסדת ומהנדסת ראשית',
      'Julia Pavlov as a voxel Software Architect character card': 'יוליה פבלוב ככרטיס דמות בסגנון voxel של ארכיטקטית תוכנה',
      'Robi, our in-house VR instructor — drag to rotate': 'רובי, מדריך ה-VR שפיתחנו. גררו כדי לסובב',
      'Meta Quest 3 headset — drag to rotate': 'משקפי Meta Quest 3. גררו כדי לסובב',
      'Interactive 3D molecule built in LiveMol — drag to rotate': 'מולקולה תלת-ממדית אינטראקטיבית שנבנתה ב-LiveMol. גררו כדי לסובב',
      'Interactive 3D enzymatic lab model built for Meta Quest — drag to rotate': 'מודל תלת-ממד אינטראקטיבי של מעבדה אנזימטית ל-Meta Quest. גררו כדי לסובב',
      'Meta Quest classroom setup': 'מערך כיתת Meta Quest',
      'LiveMol research tool': 'כלי המחקר LiveMol',
      'Fugacity VR experiment': 'ניסוי VR בפוגסיות',
      ...
      'Zoom the 3D model': 'הגדלת מודל התלת-ממד',
      'Get a project proposal': 'לייעוץ חינם',
      '◆ Robi · our VR instructor': '◆ רובי · מדריך ה-VR שלנו',
      '◆ Built in LiveMol': '◆ נבנה ב-LiveMol',
      'A 3D model we built in-house for our Meta Quest 3 lab · drag to rotate · zoom in to see inside': 'מודל תלת-ממד שבנינו בעצמנו למעבדת ה-Meta Quest 3 שלנו · גררו כדי לסובב · התקרבו כדי לראות מבפנים',
      'Robi, the in-house VR instructor that guides students through the experiment · drag to rotate': 'רובי, מדריך ה-VR שפיתחנו ומלווה את הסטודנטים לאורך הניסוי · גררו כדי לסובב',
      'An actual 3D model generated by our LiveMol app · drag to rotate · use the slider to zoom': 'מודל תלת-ממד אמיתי שנוצר באפליקציית LiveMol שלנו · גררו כדי לסובב · הזיזו את המחוון כדי להתקרב',
      'The headset our classroom runs on · drag to rotate · use the slider to zoom': 'המשקפיים שעליהם פועלת הכיתה שבנינו · גררו כדי לסובב · הזיזו את המחוון כדי להתקרב',
    },
  },
  ru: {
    ...
    text: {
      ...
      'Lioness leading three lion cubs wearing VR headsets': 'Львица и три львёнка в VR-гарнитурах',
