...
const WORK = [
  {
    ...
    lead: 'Give people a way to explore what a diagram cannot show. This mixed reality module brings molecular science onto the student’s desk and is in use at the Technion.',
    ...
    story: [
      ...
      ['The experience', 'Students compare molecules with their hands, rotate the enzyme and explore a reaction at their own pace. Robi, a bilingual virtual instructor, guides them through each activity. The real room remains visible, so the experience fits around an existing laboratory desk.'],
      ['Built for everyday use', 'The model, animation and hand interactions were designed together in Unity for Meta Quest 3. Geometry and rendering optimizations keep the visual detail within the headset’s performance budget. Independent modules let instructors revisit a specific topic without restarting the whole lesson.'],
      ['From demonstration to teaching tool', 'The module is in use at the Wolfson Faculty of Chemical Engineering, Technion. It complements the physical experiment with three activities: enzyme exploration, polarized light and molecular interaction. The video above shows the actual experience, from touch gestures to the animated reaction.'],
    ],
