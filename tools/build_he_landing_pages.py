...
<main><section class="hero-shell"><div class="hero-grid"></div><div class="hero-glow"></div><div class="wrap hero"><div class="hero-copy"><div class="eyebrow">{eyebrow}</div><h1>{title}</h1><p>{lead}</p><ul class="hero-benefits">{bullets}</ul><div class="hero-actions"><a class="btn" href="#contact">לשיחת היתכנות קצרה</a><span class="quiet">ללא התחייבות · שיחה ישירה עם מי שמאפיינת ומפתחת בפועל</span></div></div><div class="hero-stage">{hero_visual}</div></div><div class="scroll-cue">גלו עוד <i></i></div></section>
