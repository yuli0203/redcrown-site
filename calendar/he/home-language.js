(async()=>{
 ...
 const selectors=['#auth-link-microsoft','.entry-card','.footer-signin','#auth-message','#workspace-auth-status','#feedback-status','#calendar-tip-note','#calendar-feedback-form button','#theme-toggle'];
