const I18N = {
  ...
  he: {
    ...
    "work.head":"מומחים בחדשנות טכנולוגית ובעיצוב אינטראקטיבי","work.sub":"הטכניון, המוסד המוביל בהנדסה וחדשנות בישראל, בוחר בנו שוב ושוב למימוש מגוון פרויקטי VR, AR ותלת־ממד. מוצרים שמרשימים ממבט ראשון, ומוכיחים את עצמם בשימוש.","work.soonBadge":"בקרוב","work.soonTitle":"בקרוב","work.soonDesc":"מתעדכן בקרוב",
