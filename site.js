const I18N = {
  ...
  he: {
    ...
    "hero.title":"פיתוח <em>תוכנה אינטראקטיבית</em><br>למדע ולהנדסה",
    "hero.plat":"נייד<s>·</s>מחשב<s>·</s>מציאות מדומה <em>· הנדסה, תלת-ממד והטמעה תחת קורת גג אחת</em>",
    "hero.lead":"אנחנו בונים תוכנה למובייל, למחשב ולמציאות מדומה, שהופכת עבודה מדעית והנדסית מורכבת לחוויות ברורות ואינטואיטיביות, מהרעיון ועד ההטמעה בשטח.",
    ...
    "svc.mobile.title":"אפליקציות לנייד","svc.mobile.desc":"אפליקציות מסחריות ושימושיות ל-iOS ול-Android, מתוך ניסיון המייסדת במוצרים ששירתו מיליוני משתמשים.","svc.mobile.link":"גלו עוד ←",
