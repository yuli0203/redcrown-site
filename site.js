const I18N = {
  ...
  he: {
    ...
    "work.head":"מומחים בחדשנות טכנולוגית ובעיצוב אינטראקטיבי","work.sub":"הטכניון, מהמוסדות המובילים בישראל בהנדסה ובחדשנות, בוחר בנו שוב ושוב למימוש מגוון פרויקטי VR, AR ותלת־ממד.<br>אנחנו לא נרתעים מאתגרים שאין להם פתרון מוכן, והופכים רעיונות שאפתניים למוצרים איכותיים באמצעות פתרונות הנדסיים וחשיבה יצירתית.","work.soonBadge":"בקרוב","work.soonTitle":"בקרוב","work.soonDesc":"מתעדכן בקרוב",
