const I18N = {
  en: {
    ...
    "hero.lead":"We turn complex scientific and engineering ideas into software people understand and enjoy using, in virtual and augmented reality, on mobile, and on desktop. Every project is built end to end, all the way to real-world deployment.",
    ...
    "work.ar.sub":"Augmented Reality | Hand Tracking | AI Instructor",
    ...
    "about.p":"Red Crown Interactive is a development studio led by Julia Pavlov, a software engineer and specialist in real-time 3D with over ten years of experience across XR, medical, gaming, and defense, contributing to commercial products at leading companies including tech firms. Depending on each project's needs, the studio assembles and manages development, 3D, and design teams, so every project is built as a complete whole, from code to visuals. We build systems where precision, stability, and performance matter as much as the experience.",
  ...
  he: {
    ...
    "hero.lead":"אנחנו הופכים רעיונות מדעיים והנדסיים מורכבים לתוכנה שאנשים מבינים ואוהבים להשתמש בה, במציאות מדומה ורבודה, במובייל ובמחשב. כל פרויקט נבנה מקצה לקצה ומגיע עד ההטמעה בשטח.",
    ...
    "work.ar.sub":"מציאות רבודה | מעקב ידיים | מדריך AI",
    ...
    "about.p":"Red Crown Interactive הוא סטודיו פיתוח בהובלת יוליה פבלוב, מהנדסת תוכנה ומומחית לפיתוח תלת-ממד בזמן אמת, עם יותר מעשר שנות ניסיון בתחומי ה-XR, הרפואה, הגיימינג והביטחון, ותרומה למוצרים מסחריים בחברות מובילות, בהן חברות הייטק. בהתאם לצורכי הפרויקט, הסטודיו מרכיב ומנהל צוותי פיתוח, תלת-ממד ועיצוב, כך שכל פרויקט נבנה כמכלול, מהקוד ועד הוויזואליה. אנחנו בונים מערכות שבהן הדיוק, היציבות והביצועים חשובים לא פחות מהחוויה.",
  ...
  ru: {
    ...
    "hero.lead":"Мы превращаем сложные научные и инженерные идеи в программное обеспечение, которое понятно и приятно использовать: в виртуальной и дополненной реальности, на мобильных устройствах и ПК. Каждый проект создаётся от начала до конца, вплоть до внедрения.",
    ...
    "work.ar.sub":"Дополненная реальность | Отслеживание рук | ИИ-инструктор",
    ...
    "about.p":"Red Crown Interactive это студия разработки под руководством Юлии Павловой, инженера-программиста и специалиста по 3D реального времени с более чем десятилетним опытом в XR, медицине, играх и обороне, участвовавшей в коммерческих продуктах ведущих компаний, включая технологические. В зависимости от задач проекта студия собирает и ведёт команды разработки, 3D и дизайна, так что каждый проект создаётся как единое целое, от кода до визуала. Мы строим системы, где точность, стабильность и производительность важны не меньше, чем впечатление.",
