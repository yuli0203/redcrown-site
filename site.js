const I18N = {
  en: {
    ...
    "nav.home":"HOME","nav.services":"SERVICES","nav.tech":"TECHNOLOGIES","nav.work":"WORK","nav.about":"ABOUT","nav.faq":"FAQ","nav.contact":"CONTACT","nav.cta":"LET'S BUILD",
    ...
    "work.cat.mr":"Mixed Reality","work.cat.vr":"Virtual Reality","work.cat.pc":"PC Application","work.cat.hw":"Hardware Setup","work.viewcta":"View project →",
  ...
  he: {
    ...
    "nav.home":"בית","nav.services":"שירותים","nav.tech":"טכנולוגיות","nav.work":"עבודות","nav.about":"אודות","nav.faq":"שאלות נפוצות","nav.contact":"צור קשר","nav.cta":"בואו נבנה",
    ...
    "svc.pc.title":"אפליקציות למחשב","svc.pc.desc":"יישומי מחשב, סימולציות וכלי מחקר המשלבים תלת-ממד בזמן אמת, חישוב מדעי ואינטגרציות עם מערכות למידת מכונה.","svc.pc.link":"גלו עוד ←",
    ...
    "about.p":"החברה נוסדה ומנוהלת בידי יוליה פבלוב, מהנדסת ומומחית לפיתוח תלת-ממד בזמן אמת, עם יותר מעשר שנות ניסיון בתחומי ה-XR, הרפואה, הגיימינג והביטחון, ותרומה למוצרים מסחריים בחברות מובילות, בהן חברות הייטק. כיום היא מובילה בטכניון פרויקטי XR מקצה לקצה. לצד ההנדסה, כישוריה האמנותיים והעיצוביים המוכחים באים לידי ביטוי בעיצוב, ב-UX, במידול תלת-ממד ובגרפיקה ממוחשבת, כך שכל פרויקט נבנה כמכלול, מהקוד ועד הוויזואליה. החוט המקשר: תוכנה שבה הדיוק חשוב לא פחות מהחוויה.",
  ...
  ru: {
    ...
    "nav.home":"Главная","nav.services":"Услуги","nav.tech":"Технологии","nav.work":"Работы","nav.about":"О нас","nav.faq":"Вопросы","nav.contact":"Контакты","nav.cta":"Создать проект",
    ...
    "work.cat.mr":"Смешанная реальность","work.cat.vr":"Виртуальная реальность","work.cat.pc":"Приложение для ПК","work.cat.hw":"Настройка оборудования","work.viewcta":"Открыть проект →",
