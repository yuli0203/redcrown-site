const I18N = {
  en: {
    ...
    "svc.mobile.title":"MOBILE","svc.mobile.desc":"Mobile apps for iOS and Android, drawing on the founder's experience with commercial products that served millions of users.","svc.mobile.link":"EXPLORE MOBILE →",
  ...
  he: {
    ...
    "svc.mobile.title":"אפליקציות לנייד","svc.mobile.desc":"אפליקציות מובייל ל-iOS ול-Android, מתוך ניסיון המייסדת במוצרים מסחריים ששירתו מיליוני משתמשים.","svc.mobile.link":"גלו עוד ←",
  ...
  ru: {
    ...
    "svc.mobile.title":"МОБАЙЛ","svc.mobile.desc":"Мобильные приложения для iOS и Android, на основе опыта основательницы с коммерческими продуктами, которыми пользовались миллионы.","svc.mobile.link":"ПОДРОБНЕЕ О МОБАЙЛ →",
