const I18N = {
  en: {
    ...
    "hero.lead":"Red Crown Interactive is a premium AR/VR development and 3D design studio in Israel. We bring design and technology together to create immersive experiences, interactive simulations, and mobile and desktop apps in Unity.",
  ...
  he: {
    ...
    "hero.lead":"Red Crown Interactive הוא סטודיו פרימיום בישראל לפיתוח AR/VR ולעיצוב תלת־ממד. אנחנו משלבים הנדסת תוכנה מדויקת, אמנות תלת־ממד ועיצוב חוויית משתמש ליצירת חוויות אינטראקטיביות, סימולציות ואפליקציות למובייל ולמחשב ב־Unity.",
    ...
    "svc.pc.title":"להפוך מורכבות לכלי עובד","svc.pc.desc":"פיתוח אפליקציות למחשבים ולתחנות עבודה (PC): מערכות אינטראקטיביות, סימולציות וכלי תלת־ממד. אנחנו מחברים ממשק משתמש, נתונים וחישובים מורכבים למוצר אחד ברור ונוח לתפעול.","svc.pc.link":"גלו עוד ←",
    ...
    "wwd.3.title":"אמנות תלת-ממד ואנימציה","wwd.3.desc":"יצירת מודלים, אנימציות ואפקטים תלת־ממדיים ברמת פרימיום בסטודיו, ושילובם במוצר עובד. מודל האנזים ורובי המדריך הווירטואלי הם דוגמאות מהפרויקטים שלנו.",
    ...
    "work.head":"רעיונות שכבר הפכו למציאות","work.sub":"פרויקטים שנבנו כדי לפתור צורך אמיתי, ופועלים בסביבה האמיתית שלהם, לא רק בדמו.","work.soonBadge":"בקרוב","work.soonTitle":"בקרוב","work.soonDesc":"מתעדכן בקרוב",
    ...
    "work.card.vr.title":"מעבדה שאפשר להיכנס אליה","work.card.vr.tag":"VR מודרך","work.card.vr.result":"סביבת לימוד שלמה לתרגול ניסוי מעבדתי ב-VR, עם הדרכה וניטור. בשימוש פעיל בטכניון.",
    "work.card.ar.title":"להחזיק מודל מולקולרי בידיים","work.card.ar.tag":"מעקב ידיים","work.card.ar.result":"סטודנטים חוקרים מולקולות ואנזימים בידיים שלהם, על השולחן האמיתי בכיתה.",
    "work.card.ml.title":"מחישוב מדעי למודל שאפשר לחקור","work.card.ml.tag":"ML בזמן אמת","work.card.ml.result":"בונים מולקולה, מריצים חישוב, ורואים את התוצאה חוזרת ישירות למודל.",
    "work.card.class.title":"כיתת Quest מוכנה לשימוש","work.card.class.tag":"חומרה","work.card.class.result":"מערך רב-מכשירים שתוכנן סביב מה שקורה באמת בכיתה: טעינה, אחסון, בטיחות והפעלה.",
