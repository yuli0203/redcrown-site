const I18N = {
  ...
  he: {
    ...
    "about.p":"Red Crown Interactive נוסדה על בסיס יותר מעשור של פיתוח תוכנה מורכבת ברפואה, בגיימינג, בביטחון ובמחקר. בראש הסטודיו עומדת יוליה פבלוב, ארכיטקטית תוכנה שכותבת קוד, מעצבת ומדגמת בתלת-ממד, ומנהלת פרויקטים וצוותי פיתוח כשההיקף דורש זאת. כך הפרויקט נשאר שלם: אותה יד מתכננת את הארכיטקטורה, קובעת איך זה נראה, ובונה את מה שהמשתמש נוגע בו.",
