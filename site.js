const I18N = {
  ...
  he: {
    ...
    "work.ar.body":"<p><b>האתגר.</b> במעבדת הביוכימיה הסטודנטים מריצים ניסוי עם ריאקטור אנזימים, אבל אף פעם לא רואים את העולם המולקולרי שמאחוריו. האנזים נשאר בלתי נראה, הכיראליות נלמדת משרטוטים שטוחים, וקריאת הפולרימטר משתנה בלי שברור למה. הכול נשאר מופשט.</p><p><b>הפתרון.</b> בנינו מודול למידה במציאות רבודה ל-Meta Quest 3 שמניח את העולם המולקולרי ממש על שולחן המעבדה, בלי שלטים ובלי צורך בניסיון קודם. רובי, מדריך רובוט ידידותי שמדבר עברית ואנגלית, מלווה את הסטודנטים כשהם משווים מולקולות בידיים, מסובבים את האנזים, צופים בתגובה מתרחשת צעד אחר צעד, ואפילו יורים אור מקוטב על מולקולות כדי לראות איך המבנה משפיע על התוצאה. הסטודנטים יושבים ליד השולחן שלהם ורואים את החדר האמיתי סביבם לאורך כל הזמן, מה שמצמצם למינימום תחושת בחילה ומאפשר גם לסטודנטים שנמנעים בדרך כלל ממשקפי מציאות מדומה להשתתף.</p><p><b>התוצאה.</b> מה שהיה בלתי נראה במעבדה הופך למוחשי, כל מושג נבנה דרך עשייה והחלטה ומתחבר ישירות לנתונים שהסטודנטים מודדים בשולחן. המרצה שולט בקצב בזמן אמת ומקבל משוב הבנה מיידי. נבנה ומשמש בפקולטה להנדסה כימית ע\"ש וולפסון בטכניון.</p>",
