const I18N = {
  ...
  he: {
    ...
    "faq.q5":"מי בונה את הפרויקט בפועל?","faq.a5":"הפרויקט מובל ונבנה בידי המייסדת, מהנדסת ומעצבת בכירה, מקצה לקצה, ואתם מדברים ישירות עם מי שגם מתכננת וגם בונה, בלי מתווכים. הסטודיו עובד גם בשיתוף פעולה עם פרילנסרים שכבר הוכיחו את עצמם. לפרויקטים בהיקף גדול ניתן לגייס צוות מקצועי, בגיוס קפדני ובסטנדרט גבוה, שעובד תחת ההובלה והפיקוח שלה, כך שהאיכות נשמרת לכל אורך הדרך.",
