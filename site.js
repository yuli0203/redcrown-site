const I18N = {
  ...
  he: {
    ...
    "wwd.intro":"<p><strong>בעידן ה-AI, עומק הנדסי ותהליכי פיתוח חכמים מאפשרים לקחת חדשנות רחוק יותר.</strong> אנחנו מתמחים במערכות מורכבות המשלבות חישובים מדעיים, בק-אנד מתקדם ואינטגרציות בין מערכות. מתכנון הארכיטקטורה ועד לפיתוח, בדיקות והטמעה, אנחנו הופכים אתגרים טכנולוגיים למוצרים מדויקים, יציבים ובעלי ביצועים גבוהים.</p><p><strong>צוות גדול יותר אינו מבטיח יכולת טכנולוגית גבוהה יותר.</strong> העומק ההנדסי שלנו, יחד עם צוות ממוקד והטמעת AI בתהליכי הפיתוח, מאפשרים לנו להתמודד עם אתגרים מורכבים ביעילות גבוהה ובעלות תחרותית. אנחנו מקפידים על ביצועים, אבטחת מידע, בדיקות ובקרה מקצועית לאורך הדרך, עם תשתית שמתאימה לדרישות המוצר ולצמיחה שלו.</p><p><strong>העתיד לא מחכה לצוותים שיסתגלו אליו. אנחנו כבר בונים אותו.</strong></p>",
