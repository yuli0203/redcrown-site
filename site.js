const I18N = {
  en: {
    ...
    "tech.cap1":"Real-time development","tech.cap2":"Scientific computing","tech.cap3":"Platforms","tech.cap4":"Visual production",
  ...
  he: {
    ...
    "svc.xr.title":"פיתוח VR, AR ו־MR","svc.xr.desc":"פיתוח חוויות VR, AR ו־MR למגוון רחב של משקפי מציאות מדומה ורבודה. שילוב עיצוב תלת־ממד ואינטראקציות טבעיות באמצעות שלטים או מעקב ידיים, ליצירת חוויות אימרסיביות ומוצרים אינטראקטיביים.","svc.xr.link":"פיתוח VR לארגונים ←",
    "svc.mobile.title":"פיתוח אפליקציות מובייל","svc.mobile.desc":"פיתוח אפליקציות ל־iOS ול־Android, מתוך ניסיון של המייסדת במוצרים ששירתו מיליוני משתמשים. לצד אפליקציות מובייל, אנחנו מפתחים חוויות AR עם ARKit, ARCore ו־AR Foundation ב־Unity.","svc.mobile.link":"גלו עוד ←",
    "svc.pc.title":"פיתוח תוכנה למחשב","svc.pc.desc":"פיתוח אפליקציות למחשבים ולתחנות עבודה (PC): מערכות אינטראקטיביות, סימולציות וכלי תלת־ממד. אנחנו מחברים ממשק משתמש, נתונים וחישובים מורכבים למוצר אחד ברור ונוח לתפעול.","svc.pc.link":"גלו עוד ←",
    "svc.web.title":"פיתוח אתרים ואפליקציות Web","svc.web.desc":"אתרים ואפליקציות שפועלים ישירות בדפדפן, ללא התקנה. ממשקים רספונסיביים למחשב ולמובייל, עם אפשרות לשילוב תלת-ממד ותוכן אינטראקטיבי.","svc.web.link":"נדבר על הפרויקט ←",
    "svc.design.title":"מידול תלת-ממד ועיצוב UI/UX","svc.design.desc":"בניית מודלים ואנימציות תלת-ממד בהתאמה אישית, לצד אפיון חוויית משתמש ועיצוב ממשקים. מהשפה החזותית ועד לפרטי האינטראקציה, למוצר שנראה מצוין ונוח לשימוש.","svc.design.link":"גלו עוד ←",
    "wwd.kicker":"עיצוב ופיתוח מוצר מקצה לקצה",
    "wwd.intro":"<p><strong>בעידן ה-AI, חדשנות לא אמורה להיות תהליך מסורבל ויקר.</strong> פרויקטים עם חישובים מדעיים ואינטגרציות בין מערכות נמצאים בליבת המומחיות שלנו. אנחנו מתכננים את הארכיטקטורה, מפתחים את המערכות ומובילים את הפרויקט עד למוצר עובד, בדוק ויציב.</p><p><strong>צוות גדול יותר אינו מבטיח יכולת טכנולוגית גבוהה יותר.</strong> העומק ההנדסי שלנו, יחד עם צוות ממוקד והטמעת AI בתהליכי הפיתוח, מאפשרים לנו להתמודד עם אתגרים מורכבים ביעילות גבוהה יותר ובעלות נמוכה יותר מחברות גדולות שטרם אימצו תהליכים אלה. אנחנו מקפידים על ביצועים, אבטחת מידע, בדיקות ובקרה מקצועית לאורך הדרך, עם תשתית שמתאימה לדרישות המוצר ולצמיחה שלו.</p><p><strong>העתיד לא מחכה לצוותים שיסתגלו אליו. אנחנו כבר בונים אותו.</strong></p>",
    ...
    "work.head":"מומחים בחדשנות טכנולוגית ובעיצוב אינטראקטיבי","work.sub":"<p>הטכניון, מהמוסדות המובילים בישראל בהנדסה ובחדשנות, בוחר בנו שוב ושוב לפיתוח פרויקטי <span class=\"keep-together\">VR, AR ותלת-ממד.</span></p><p><strong>אנחנו לא נרתעים מאתגרים שעדיין אין להם פתרון מוכן.</strong> מסימולציות לימודיות ועד לכלי מחקר מולקולריים הכוללים מערכות בק-אנד מורכבות, אנחנו מחברים מומחיות הנדסית, חשיבה יצירתית ועיצוב מוקפד כדי להפוך רעיונות שאפתניים למוצרים איכותיים, יציבים ומדויקים.</p>","work.soonBadge":"בקרוב","work.soonTitle":"בקרוב","work.soonDesc":"מתעדכן בקרוב",
    ...
    "about.p":"Red Crown Interactive נוסדה מתוך יותר מעשור של ניסיון בבניית תוכנה מורכבת במגוון תעשיות כגון רפואה, גיימינג, ביטחון ומחקר, כדי לתת ללקוחות דרך ישירה יותר להפוך רעיון למוצר. הסטודיו משלב הנדסת תוכנה, תלת-ממד וגרפיקה בזמן אמת עם תכנון הוויזואליה והאינטראקציה כבר מתחילת הדרך. כל פתרון נבנה סביב המטרות המקצועיות של הפרויקט והאנשים שישתמשו בו. בראש הסטודיו עומדת יוליה פבלוב, מהנדסת תוכנה המתמחה בתלת-ממד ובגרפיקה בזמן אמת. העבודה מתנהלת ישירות עם מי שמובילה את הפיתוח, עם ליווי אישי ורציף מהרעיון ועד ההטמעה.",
    "about.xpk":"הניסיון של המייסדת",
    "tech.k":"טכנולוגיות","tech.dev":"פיתוח","tech.design":"עיצוב",
    "tech.cap1":"פיתוח בזמן אמת","tech.cap2":"מחשוב מדעי","tech.cap3":"פלטפורמות","tech.cap4":"הפקה חזותית",
    ...
    "faq.q1":"כמה עולה לפתח אפליקציית מציאות מדומה או VR?","faq.a1":"עלות הפיתוח תלויה בהיקף, בפלטפורמה ובמורכבות התוכן. אנחנו מתחילים בשיחה קצרה כדי להבין מה אתם צריכים, ונותנים הערכת מחיר ברורה ושקופה עוד לפני שמתחילים, בלי הפתעות.",
    "faq.q2":"כמה זמן לוקח פיתוח של אפליקציה כזו?","faq.a2":"זה תלוי בהיקף. מודול ממוקד יכול לצאת לדרך תוך שבועות, ומערכת גדולה יותר לוקחת יותר. אנחנו מגדירים יעדים ואבני דרך מראש, כך שתמיד יש לכם תמונה ברורה של הקצב.",
  ...
  ru: {
    ...
    "tech.cap1":"Разработка в реальном времени","tech.cap2":"Научные вычисления","tech.cap3":"Платформы","tech.cap4":"Визуальное производство",
