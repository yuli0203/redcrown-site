const I18N = {
  ...
  he: {
    ...
    "wwd.intro":"<p><strong>בעידן ה-AI, חדשנות לא אמורה להיות תהליך מסורבל ויקר.</strong> פרויקטים עם חישובים מדעיים ואינטגרציות בין מערכות נמצאים בליבת המומחיות שלנו. אנחנו מתכננים את הארכיטקטורה, מפתחים את המערכות ומובילים את הפרויקט עד למוצר עובד, בדוק ויציב.</p><p><strong>צוות גדול יותר אינו מבטיח יכולת טכנולוגית גבוהה יותר.</strong> העומק ההנדסי שלנו, יחד עם צוות ממוקד והטמעת AI בתהליכי הפיתוח, מאפשרים לנו להתמודד עם אתגרים מורכבים ביעילות גבוהה ובעלות תחרותית. אנחנו מקפידים על ביצועים, אבטחת מידע, בדיקות ובקרה מקצועית לאורך הדרך, עם תשתית שמתאימה לדרישות המוצר ולצמיחה שלו.</p><p><strong>העתיד לא מחכה לצוותים שיסתגלו אליו. אנחנו כבר בונים אותו.</strong></p>",
