const I18N = {
  ...
  he: {
    ...
    "svc.xr.title":"פיתוח VR, AR ו־MR","svc.xr.desc":"פיתוח חוויות VR, AR ו־MR למגוון רחב של משקפי מציאות מדומה ורבודה. שילוב עיצוב תלת־ממד ואינטראקציות טבעיות באמצעות שלטים או מעקב ידיים, ליצירת חוויות אימרסיביות ומוצרים אינטראקטיביים.","svc.xr.link":"גלו עוד ←",
    ...
    "work.head":"מומחים בחדשנות טכנולוגית ובעיצוב אינטראקטיבי","work.sub":"הטכניון בוחרים בנו שוב ושוב למימוש מגוון פרויקטי VR, AR ותלת־ממד. מוצרים שמרשימים ממבט ראשון, ומוכיחים את עצמם בשימוש.","work.soonBadge":"בקרוב","work.soonTitle":"בקרוב","work.soonDesc":"מתעדכן בקרוב",
