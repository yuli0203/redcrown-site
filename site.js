const I18N = {
  ...
  he: {
    ...
    "wwd.intro":"<p><strong>בעידן ה-AI, מצוינות הנדסית היא גם לדעת לעבוד חכם יותר.</strong> מחישובים מדעיים ובק-אנד מתקדם ועד אינטגרציות מורכבות, אנחנו מובילים את הפיתוח מהארכיטקטורה ועד להטמעה, עם דיוק, ביצועים, יציבות ואבטחת מידע.</p><p><strong>צוות גדול יותר אינו מבטיח יכולת טכנולוגית גבוהה יותר.</strong> אנחנו משלבים צוות ממוקד ומנוסה עם AI, בדיקות ובקרה מקצועית כדי לבנות מוצרים ביעילות גבוהה ובעלות תחרותית, עם תשתית שמוכנה לצמיחה.</p>",
