const I18N = {
  en: {
    ...
    "svc.mobile.title":"MOBILE","svc.mobile.desc":"Commercial and utility mobile apps for iOS and Android, drawing on the founder's experience with products that served millions of users.","svc.mobile.link":"EXPLORE MOBILE →",
  ...
  he: {
    ...
    "wwd.2.title":"פיתוח","wwd.2.desc":"בנוי נכון מבפנים, יציב ומודולרי, כדי שיהיו פחות תקלות ופחות הפתעות יקרות בהמשך.",
