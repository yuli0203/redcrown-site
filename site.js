const I18N = {
  ...
  he: {
    ...
    "about.p":"Red Crown Interactive נוסדה על בסיס יותר מעשור של ניסיון בפיתוח תוכנה מורכבת בתחומי הרפואה, הגיימינג, הביטחון והמחקר. בראש הסטודיו עומדת יוליה פבלוב, מהנדסת תוכנה המתמחה בתלת-ממד ובגרפיקה בזמן אמת. אנחנו משלבים הנדסת תוכנה עם עיצוב חזותי ותכנון אינטראקציות כבר מתחילת הדרך, ובונים כל פתרון סביב מטרות הפרויקט והאנשים שישתמשו בו. אתם עובדים ישירות עם מי שמובילה את הפיתוח, בליווי אישי ורציף מהרעיון ועד ההטמעה.",
