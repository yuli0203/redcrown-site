const I18N = {
  ...
  he: {
    ...
    "work.head":"מומחים בחדשנות טכנולוגית ובעיצוב אינטראקטיבי","work.sub":"<p>הטכניון, מהמוסדות המובילים בישראל בהנדסה ובחדשנות, בוחר בנו שוב ושוב למימוש מגוון פרויקטי VR, AR ותלת־ממד.</p><p><strong>אנחנו לא נרתעים מאתגרים שאין להם פתרון מוכן.</strong> באמצעות פתרונות הנדסיים וחשיבה יצירתית, אנחנו הופכים רעיונות שאפתניים למוצרים איכותיים.</p>","work.soonBadge":"בקרוב","work.soonTitle":"בקרוב","work.soonDesc":"מתעדכן בקרוב",
