const I18N = {
  ...
  he: {
    ...
    "hero.plat":"אפליקציות למובייל ולמחשב, תלת־ממד אינטראקטיבי ופתרונות VR ו־AR.",
    ...
    "work.head":"מובילים בחדשנות טכנולוגית ובעיצוב אינטראקטיבי","work.sub":"הטכניון בחרו בנו למימוש מגוון פרויקטי VR, AR ותלת־ממד.","work.soonBadge":"בקרוב","work.soonTitle":"בקרוב","work.soonDesc":"מתעדכן בקרוב",
    ...
    "work.card.ml.title":"LiveMol למחקר מולקולרי","work.card.ml.tag":"ML בזמן אמת","work.card.ml.result":"עריכת מולקולות והצגת תוצאות חישוב בתלת־ממד.",
