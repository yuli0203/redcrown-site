const I18N = {
  ...
  he: {
    ...
    "hero.plat":"פיתוח בהתאמה אישית למחקר, לחדשנות ולהדרכה <em>· נייד · מחשב · מציאות מדומה</em>",
    ...
    "wwd.3.title":"אמנות תלת-ממד ואנימציה","wwd.3.desc":"נכסי תלת-ממד, אנימציות ואפקטים שגורמים למוצר להיראות אמין ומקצועי מהרגע הראשון.",
    "wwd.4.title":"אופטימיזציה","wwd.4.desc":"חוויה חלקה שעובדת על החומרה האמיתית שלכם, גם כשהתוכן כבד ומורכב.",
