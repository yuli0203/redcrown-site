const I18N = {
  ...
  he: {
    ...
    "about.p":"Red Crown Interactive נוסדה על בסיס יותר מעשור של ניסיון בפיתוח תוכנה מורכבת בתחומי הרפואה, הגיימינג, הביטחון והמחקר. בראש הסטודיו עומדת יוליה פבלוב, ארכיטקטית תוכנה שמשלבת באדם אחד יכולות של צוות שלם: כתיבת קוד, עיצוב ומידול תלת-ממד. השילוב הזה נותן ראייה רוחבית על הפרויקט כולו, כזו שקשה להשיג כשכל תחום יושב אצל אדם אחר, ומאפשר לבנות כל פתרון סביב מטרות הפרויקט והאנשים שישתמשו בו. אתם עובדים ישירות עם מי שמובילה את הפיתוח, בליווי אישי ורציף מהרעיון ועד ההטמעה.",
