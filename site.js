const I18N = {
  en: {
    ...
    "svc.xr.title":"XR / VR / AR","svc.xr.desc":"Custom VR, AR and MR experiences for a wide range of virtual and augmented reality headsets. We combine 3D design with natural interactions through controllers, hand tracking and eye tracking to create immersive experiences and interactive products.","svc.xr.link":"EXPLORE XR →",
    "svc.mobile.title":"MOBILE","svc.mobile.desc":"Custom iOS and Android apps, drawing on the founder’s experience with products that served millions of users. We also build mobile AR experiences with ARKit, ARCore and Unity AR Foundation.","svc.mobile.link":"EXPLORE MOBILE →",
    "svc.pc.title":"PC","svc.pc.desc":"Custom applications for PCs and workstations: interactive systems, simulations and 3D tools. We bring user interfaces, data and complex calculations together in one clear, easy-to-use product.","svc.pc.link":"EXPLORE PC →",
  ...
  he: {
    ...
    "hero.lead":"Red Crown Interactive הוא בית תוכנה וסטודיו לעיצוב מוצרים דיגיטליים למחקר, לתעשייה ולסטארטאפים. אנחנו משלבים הנדסת תוכנה, יצירתיות ועיצוב, ומלווים אתכם מהרעיון וה-MVP ועד למוצר מלא.",
    ...
    "svc.xr.title":"פיתוח VR, AR ו־MR","svc.xr.desc":"פיתוח חוויות VR, AR ו-MR למגוון רחב של משקפי מציאות מדומה ורבודה. אנחנו משלבים עיצוב תלת-ממד עם אינטראקציות טבעיות באמצעות שלטים, מעקב ידיים ומעקב עיניים, ליצירת חוויות סוחפות ומוצרים אינטראקטיביים.","svc.xr.link":"פיתוח VR לארגונים ←",
    "svc.mobile.title":"פיתוח אפליקציות מובייל","svc.mobile.desc":"פיתוח אפליקציות ל-iOS ול-Android, על בסיס הניסיון של המייסדת במוצרים ששירתו מיליוני משתמשים. אנחנו מפתחים גם חוויות AR למובייל עם ARKit, ARCore ו-AR Foundation ב-Unity.","svc.mobile.link":"גלו עוד ←",
    ...
    "about.p":"Red Crown Interactive נוסדה על בסיס יותר מעשור של ניסיון בפיתוח תוכנה מורכבת בתחומי הרפואה, הגיימינג, הביטחון והמחקר. בראש הסטודיו עומדת יוליה פבלוב, ארכיטקטית תוכנה שמשלבת באדם אחד יכולות של צוות שלם: כתיבת קוד, עיצוב ומידול תלת-ממד, לצד ניסיון בניהול צוותי פיתוח שמאפשר להרחיב את הצוות לפי היקף הפרויקט.","about.p2":"השילוב הזה נותן ראייה רוחבית על הפרויקט כולו, כזו שקשה להשיג כשכל תחום יושב אצל אדם אחר, ומאפשר לנו לבנות כל פתרון סביב מטרות הפרויקט והאנשים שישתמשו בו. הליווי נמשך ברצף מהרעיון ועד ההטמעה.",
  ...
  ru: {
    ...
    "svc.xr.title":"XR / VR / AR","svc.xr.desc":"Симуляции, лаборатории и обучающие сценарии в VR, AR и MR, с управлением руками, жестами, взглядом и контроллерами, адаптированным под пользователя и рабочую среду. Создано на Meta Quest 3.","svc.xr.link":"ПОДРОБНЕЕ О XR →",
