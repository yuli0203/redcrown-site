const I18N = {
  ...
  he: {
    ...
    "work.head":"מומחים בחדשנות טכנולוגית ובעיצוב אינטראקטיבי","work.sub":"<p>הטכניון, מהמוסדות המובילים בישראל בתחומי ההנדסה והחדשנות, בוחר בנו פעם אחר פעם לפיתוח פרויקטים מתקדמים ב-VR, ב-AR ובתלת-ממד.</p><p><strong>אנחנו לא נרתעים מאתגרים שעדיין אין להם פתרון מוכן.</strong> מסימולציות לימודיות ועד לכלי מחקר מולקולריים הכוללים מערכות בק-אנד מורכבות, אנחנו מחברים מומחיות הנדסית, חשיבה יצירתית ועיצוב מוקפד כדי להפוך רעיונות שאפתניים למוצרים איכותיים, יציבים ומדויקים.</p><p><strong>העתיד לא מחכה לצוותים שיסתגלו אליו. אנחנו כבר בונים אותו.</strong></p>","work.soonBadge":"בקרוב","work.soonTitle":"בקרוב","work.soonDesc":"מתעדכן בקרוב",
