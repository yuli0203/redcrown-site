const I18N = {
  en: {
    ...
    "svc.mobile.title":"MOBILE","svc.mobile.desc":"Custom iOS and Android apps, drawing on the founder’s experience with products that served millions of users. We also build mobile AR experiences with ARKit, ARCore and AR Foundation in Unity, or fully native.","svc.mobile.link":"EXPLORE MOBILE →",
  ...
  he: {
    ...
    "svc.mobile.title":"פיתוח אפליקציות מובייל","svc.mobile.desc":"פיתוח אפליקציות ל-iOS ול-Android, על בסיס הניסיון של המייסדת במוצרים ששירתו מיליוני משתמשים. אנחנו מפתחים גם חוויות AR למובייל עם ARKit, ARCore ו-AR Foundation ב-Unity וגם ב-native.","svc.mobile.link":"גלו עוד ←",
