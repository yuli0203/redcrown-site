...
These are justifications for implemented features, not a request for broader calendar, Gmail, contacts or Drive access. Confirm the Firebase sign-in scopes separately before submitting the complete project inventory. No scopes were added to the console in this review and no user grants were expanded.
